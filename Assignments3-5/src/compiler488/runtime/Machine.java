...
public final class Machine
     ...
     */
    public final static void writeMemory( short addr , short value ) throws MemoryAddressException {
        ...
        if(tracing)
        {
           ...
           printThis.insert( 0 , pc + ": " );
                    ...
                    for(int i = 0; i <= displayMax; i++)
                        System.out.print(display[i] + "  ");
                    System.out.print("\n");
                    System.out.println("\t\t    pc " + pc + " msp " + msp + " mlp " + mlp);
        ...
        case SETD:
            {
                ...
                if( adr != MIN_INTEGER ){  // special case - uninitialized
                    // System.out.println("-2: " + memory[msp-2]);
                    // System.out.println("-1: " + memory[msp-1]);
                    // System.out.println(" 0: " + memory[msp]);
                    // System.out.println(" 1: " + memory[msp+1]);
                    // System.out.println(" 2: " + memory[msp+2]);
                    rangeCheck(adr, bottomOfStack, mlp,
                        "SETD display entry " + adr + " out of range.\n") ;
                }
